...
var spriteSheets = {
    ...
    imagePath = {
        ...
        earthBabyDragon: "baby2808a.png",
        earthBabyDragon1: "baby2808a1.png",
        cart: "cart.png",
...
ig.module("game.entities.game-control")
    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
            ...
            imageEarthBabyDragon: new ig.Image(imagePath.earthBabyDragon),
            imageEarthBabyDragon1: new ig.Image(imagePath.earthBabyDragon1),
            ...
            drawEarthDragon: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    if (this.isEvelveDragon == 1) {
                        ...
                        var b = ig.system.context;
                        b.save();
                        b.translate(this.earthDragonX + this.imageEarthBabyDragon.width * 0.11 / 2, 590 + this.imageEarthBabyDragon.height * 0.13);
                        b.scale(0.11 * this.scaleMonster1.x, 0.13 * this.scaleMonster1.y);
                        if (this.isDragonLeft == 1) {
                            this.imageEarthBabyDragon.draw(-this.imageEarthBabyDragon.width / 2, -this.imageEarthBabyDragon.height);
                        } else {
                            this.imageEarthBabyDragon1.draw(-this.imageEarthBabyDragon1.width / 2, -this.imageEarthBabyDragon1.height);
                        }
                        b.restore();
                    }
                    ...
                    if (this.isEvelveDragon == 1) {
                        ...
                        var b = ig.system.context;
                        b.save();
                        b.translate(this.earthDragonXLand + this.imageEarthBabyDragon.width * 0.12 / 2, 300 + this.imageEarthBabyDragon.height * 0.10);
                        b.scale(0.12 * this.scaleMonster1.x, 0.10 * this.scaleMonster1.y);
                        if (this.isDragonLeft == 1) {
                            this.imageEarthBabyDragon.draw(-this.imageEarthBabyDragon.width / 2, -this.imageEarthBabyDragon.height);
                        } else {
                            this.imageEarthBabyDragon1.draw(-this.imageEarthBabyDragon1.width / 2, -this.imageEarthBabyDragon1.height);
